...
export const AppVariables = {
  ApiKeyHeader:
    'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImhzdWtyZnRxdmN3emVodnpydmV6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTgyOTc0MDEsImV4cCI6MjA3Mzg3MzQwMX0.O6B5ZxmkDt3QQ8Gl2AEKMr7wxFhKTD6coWgyPHcAPD0',
  SupabaseUrl: 'https://hsukrftqvcwzehvzrvez.supabase.co',
};
